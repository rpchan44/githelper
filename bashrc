...
process() {
    ...
    # Push branch (force-with-lease keeps remote safe)
    echo "Pushing branch: $branch"
    git push --force-with-lease origin "$branch" || {
        echo "Push failed. Resolve issues manually."
        return 1
    }
...
githelp() {
    ...
    echo -e "  \e[1;36mnuke\e[0m       Genesis Branch"
